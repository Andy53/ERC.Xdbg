...
namespace ERC.Cli
{
    ...
    public static class CommandHelp
    {
        ...
        private static readonly string[] TextLines =
        {
            ...
            "   --StackPivot    |",
            "       Finds instructions that move the stack pointer: \"xchg reg, esp\", \"mov esp, reg\", \"leave\",",
            "       \"add esp, n\" and \"ret n\". A chain has to be reached before it can run, and when the crash",
            "       gives too few bytes to hold one, a pivot is what gets execution to where the chain is.",
            "       Takes an optional minimum distance in bytes, for when the chain is known to be far away.",
            "       Example: ERC --StackPivot. Every pivot in the process.",
            "       Example: ERC --StackPivot 200. Only those moving the stack pointer at least 200 bytes.",
            "   --SehChain      |",
